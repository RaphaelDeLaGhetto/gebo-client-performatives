/**
 * This Gruntfile was pilfered from the good 
 * folk doing angular-bootstrap
 *
 * 2013-11-28
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    meta: {
      modules: 'angular.module("gebo-client-performatives", [<%= srcModules %>]);',
    ...
    changelog: {
      options: {
        ...
        github: 'RaphaelDeLaGhetto/gebo-client-performatives'
      }
    },
    shell: {
    ...
    ngdocs: {
      options: {
        ...
        title: 'gebo-client-performatives',
        html5Mode: false
      },
      api: {
  ...
  //Common gebo-client-performatives module containing all modules for src and templates
  ...
  function findModule(name) {
    ...
    var module = {
      name: name,
      moduleName: enquote('gebo-client-performatives.' + name),
  ...
  function dependenciesForModule(name) {
    ...
    .forEach(function(contents) {
      ...
      dependencies.split(',').forEach(function(dep) {
        if (dep.indexOf('gebo-client-performatives.') > -1) {
          var depName = dep.trim().replace('gebo-client-performatives.','').replace(/['"]/g,'');
  ...
  grunt.registerTask('build', 'Create gebo-client-performatives build files', function() {
    var _ = grunt.util._;
